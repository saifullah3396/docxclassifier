...
usage() {
  echo "Usage:"
  echo "./prepare_dataset.sh --type=<type>"
  echo ""
...
python3 -W ignore $SCRIPT_DIR/../src/docxclassifier/runners/prepare_dataset.py --config-path ../../../cfg/ --config-name hydra +prepare_dataset=hydra "${@:1}"
